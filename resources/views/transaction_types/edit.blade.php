                ...
                <div class="pd-10 card-box mb-20 mt-20">
                    <div class="col-md-12 pl-0 my-2">
                        <div class="d-flex justify-content-between mb-20 col-md-12">
                            <h3 class="text-blue">Update Transection Type</h3>
                            <div class="">
                    ...
                    <div class="col-md-12 mb-3">
                        @if ($transactionTypes)
                            @foreach ($transactionTypes as $transactionType)
                                <form action="{{ route('transaction-type.update', $transactionType->id) }}" method="POST">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Transection Type:<span class="text-danger font-20 mt-0">*</span></label>
                                                <input class="form-control" type="text" placeholder="Transection Type" name="name"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a role="button" href="{{ route('transaction-type.index') }}"
