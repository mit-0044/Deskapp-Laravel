                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-between">
                            ...
                            <div class="my-auto">
                                <a href="{{ route('role.show_deleted') }}" class="btn btn-danger btn-lg">Deleted Roles</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="pd-10 card-box mb-20 mt-20">
                    <div class="col-md-12 pl-0 mt-2">
                        <div class="d-flex justify-content-between mb-20 col-md-12 pr-0">
                            ...
                            <a href="{{ route('role.create') }}" role="button" class="btn btn-primary btn-lg ml-0">ADD</a>
                        </div>
                    </div>
                    @if (session()->has('add'))
                                ...
                                <tbody>
                                    @foreach ($roles as $role)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $name = DB::table('role_has_permissions')
                                                ...
                                                @foreach ($name as $val)
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="badge badge-info mr-1 mb-1">{{ $permission[0]->name }}</span>
                                                @endforeach
                                            </td>
                                            <td>
                                                <div class="d-flex">
