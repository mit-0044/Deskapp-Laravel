                ...
                <div class="pd-10 card-box mb-20 mt-20">
                    <div class="col-md-12 pl-0 my-2">
                        <div class="d-flex justify-content-between mb-20 col-md-12">
                            <h3 class="text-blue">Edit Note</h3>
                        </div>
                    </div>
                                            ...
                                            <select class="form-control" name="project_id">
                                                ...
                                                @foreach ($projects as $project)
                                                    <option value="{{ $project->id }}"
                                                        @if ($project->id == $note->project_id) selected @endif>
                                                        {{ $project->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" type="text" placeholder="Note" name="note_text" />{{ $note->note_text }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
