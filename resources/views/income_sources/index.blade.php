                ...
                <div class="pd-10 card-box mb-20 mt-20">
                    <div class="col-md-12 pl-0 mt-2">
                        <div class="d-flex justify-content-between mb-20 col-md-12 pr-0">
                            <h3 class="text-blue">Income Source</h3>
                            <a href="{{ route('income-source.create') }}" role="button"
                                ...
                                <tbody>
                                    @foreach ($incomeSources as $incomeSource)
                                        <tr>
                                            ...
                                            <td>{{ $incomeSource->fee_percent }}</td>
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('income-source.show', $incomeSource->id) }}"
                                                        class="btn text-white font-12 btn-info btn-sm mx-1">View</a>
                                                    <a href="{{ route('income-source.edit', $incomeSource->id) }}"
                                                        class="btn text-white font-12 btn-primary btn-sm mx-1">Edit</a>
                                                    <form action="{{ route('income-source.destroy', $incomeSource->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
