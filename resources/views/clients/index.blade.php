                ...
                <div class="pd-10 card-box mb-20 mt-20">
                    <div class="col-md-12 pl-0 mt-2">
                        <div class="d-flex justify-content-between mb-20 col-md-12 pr-0">
                            ...
                            <a href="{{ route('client.create') }}" role="button"
                                ...
                                <tbody>
                                    @foreach ($clients as $client)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn-link text-decoration-underline weight-500"
                                                    href={{ $client->company }} target="_blank">{{ $client->website }}</a>
                                            </td>
                                            <td>
                                                @php
                                                    $country = DB::table('country')
                                                        ->where('countryid', $client->country)
                                                        ->get();
