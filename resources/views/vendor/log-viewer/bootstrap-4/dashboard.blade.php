    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header mb-4 d-flex justify-content-between">
                <div>
                    <a role="button" href="{{ url('log-viewer') }}" class="btn btn-outline-primary active mr-1 px-4">All
                        Log</a>
                    <a role="button" href="{{ url('log-viewer/logs') }}" class="btn btn-outline-primary px-3">Log Detail</a>
                </div>
                <h3 class="text-primary">@lang('All Logs')</h3>
                            ...
                            <div class="row">
                                @foreach ($percents as $level => $item)
                                    <div class="col-sm-6 col-md-12 col-lg-4 mb-3">
                                        <div
                                            class="box level-{{ $level }} {{ $item['count'] === 0 ? 'empty' : '' }}">
                                            <div class="box-icon">
