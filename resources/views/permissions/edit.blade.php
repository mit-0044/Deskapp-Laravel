                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 d-flex justify-content-between">
                            ...
                            <div class="mt-1">
                                <a href="{{ route('permission.index') }}" role="button"
                ...
                <div class="pd-10 card-box mb-20 mt-20">
                    <div class="col-md-12 pl-0 my-2">
                        <div class="d-flex justify-content-between mb-20 col-md-12">
                            <h3 class="text-blue">Edit Permission</h3>
                        </div>
                    </div>
                            ...
                            <form action="{{ route('permission.update', $permission->id) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Permission Name:<span class="text-danger font-20 mt-0">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a role="button" href="{{ route('permission.index') }}"
